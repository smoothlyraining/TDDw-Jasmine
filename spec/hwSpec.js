...
describe("Sum1toN", function() { 
    ...
    it("should return 15 when we pass 6 as an argument", function(){ // added by me
...
describe("sumFirstLast", function() { 
    ...
    it("should return -4 when we pass [-4,2,0] as an argument", function(){ // added by me
        expect(sumFirstLast([-4,2,0])).toEqual(-4);
    });
});
